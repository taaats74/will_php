...
<?php if ( ! $bcl_noindex ) : ?>
  ...
  <script type="application/ld+json">
  {
    ...
    "mainEntity": [
      ...
      {"@type": "Question", "name": "ホームページについての相談もできますか？", "acceptedAnswer": {"@type": "Answer", "text": "はい、ご相談いただけます。ホームページから問い合わせが増えない原因は、集客・導線・受け皿のどこかにあるケースが多いです。無料診断で現状を整理したうえで、Webサイトのどこから手をつけるべきかをお伝えします。"}}
    ]
  }
  </script>
<?php endif; ?>
