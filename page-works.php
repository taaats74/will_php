...
$service_cards = [
  [
    ...
    'label' => 'WILLSUPPORT',
    'title' => 'ウィルサポ',
    'lead'  => 'BtoB企業向けのサブスク型ホームページサービス。月額制でサイト改善まで伴走します。',
  ],
  [
  ...
  <div class="container">
    <div class="wrapper">
      ...
      <div class="works-header">
        ...
        <p class="lead">
          BtoB企業に特化し、製造・IT・士業・不動産など幅広い業種のホームページ制作を伴走支援してきました。<br>
...
<section class="page-topv3-diagnosis" id="diagnosis-banner">
  <div class="container">
    ...
    <div class="diagnosis-panel">
      ...
      <a href="<?php echo esc_url( home_url('/btob-marketing-consultation/') ); ?>" target="_blank" rel="noopener noreferrer" class="diagnosis-btn">1分でできる無料診断を受ける</a>
    </div>
