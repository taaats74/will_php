...
<?php if ( ! $wg2_noindex ) : ?>
  ...
  <script type="application/ld+json">
  {
    ...
    "mainEntity": [
      ...
      {"@type": "Question", "name": "どこまでがプラン内で、どこからが別料金ですか？", "acceptedAnswer": {"@type": "Answer", "text": "いまあるページに手を入れる作業はプラン内、新しくつくるものは別途お見積りのケースが多いです。実際には、御社のサイトの状態によって変わります。別途お見積りとなる場合は、必ず事前に金額をお伝えし、ご了承いただいてから着手します。知らないうちに費用が増えることはありません。"}},
      ...
      {"@type": "Question", "name": "契約期間や解約の縛りはありますか？", "acceptedAnswer": {"@type": "Answer", "text": "ありません。初期費用は0円、最低契約期間もありません。月単位の自動更新なので、合わないと感じられた時点で終了できます。長期契約で縛らないのは、続けたいと思っていただける成果を出すことが、私たちの仕事だと考えているからです。※解約をご希望の場合は、1ヶ月前までにご連絡ください"}},
      {"@type": "Question", "name": "社内にWebやマーケに詳しい人がいなくても大丈夫ですか？", "acceptedAnswer": {"@type": "Answer", "text": "はい、問題ございません。そのような会社のためにつくったサービスです。御社にお願いするのは、月に一度の打ち合わせと、事業のことを教えていただくことだけです。記事を書くのも、サイトを直すのも、数字を見るのも私たちが行います。ご報告に専門用語は使いません。決めていただくのは、方針だけです。※設計プラン（月10万円）のみ、実行は御社で行っていただきます。動ける方が社内にいない場合は、問い合わせプラン以上をお選びください。"}},
      {"@type": "Question", "name": "いまお願いしている会社で、成果が出ていません。何か変わりますか？", "acceptedAnswer": {"@type": "Answer", "text": "まず、うまくいっていない原因を確かめるところから始めます。成果が出ない理由は、いくつかに分かれます。狙う相手や言葉がずれている。実行が途中で止まっている。そもそも何が起きているかを測れていない。サイトの構造そのものに問題がある。原因が分からないまま依頼先だけを変えても、同じことが繰り返されます。まずは無料診断からお試しください10の質問に答えるだけ、約1分です。いまの取り組みのどこに課題がありそうかを整理して、レポートをお送りします。費用はかかりません。そのまま切り替えを検討する必要もありません。もう少し詳しく見てほしいという場合は、無料相談で実際のサイトを拝見してお伝えします。その時点で私たちに向かないと判断した場合は、正直にそう申し上げます。無料診断へご依頼いただいた場合も、進め方は毎月見直します方針を決めて終わりにはしません。毎月、何が起きたかをご報告し、効いていない施策は切り替えます。3ヶ月ごとには、方向そのものを見直します。契約の縛りもありませんので、合わないと感じられた時点で終了していただけます。"}},
      ...
      <div class="wg2-container">
        ...
        <div class="wg2-message">
          <figure class="wg2-message__photo">
            <img src="<?php echo esc_url( will_asset_url( 'img/page-top2-logo-bg.webp' ) ); ?>" alt="" width="754" height="383" loading="lazy" decoding="async">
          </figure>

          <div class="wg2-message__body">
          <p>BtoBマーケティングで本当に重要なのは、問い合わせの「数」だけではありません。<br>どれだけ問い合わせを増やしても、お客様の温度感が低いものだと営業の成果も出づらく、売り上げにはつながらない。</p>
          <p>一方で、自社のサービスを本当に必要としている企業から、一件の問い合わせが届く。その一件が商談になり、契約につながり、事業を大きく動かすこともあります。</p>
          <p>ウィルが大切にしているのは、<strong>「問い合わせを増やすこと」ではなく、「商談につながる見込み客を生み出し、売上につなげること」</strong>です。</p>
          <p>この考え方の根底にあるのが、10年以上にわたるBtoBマーケティングの経験です。</p>
          <p>見込み客を集める仕組みづくりから、インサイドセールスの立ち上げ・マネジメントまで、マーケティングと営業の両方を経験してきたからこそ、<strong>集客だけではなく、その先の商談・売上まで見据えたマーケティング</strong>を設計できます。</p>
          <p>そして、マーケティングでは「何をするか」だけでなく、<strong>「誰に、何を、どう伝えるか」</strong>も重要です。</p>
          <p>目的やターゲットに合わせて伝えるべきメッセージを整理し、ターゲットに伝わる言葉と、直感的に価値が伝わるデザインに落とし込む。</p>
          <p><strong>マーケティングを設計する力と、価値を伝える力。</strong></p>
          <p>この2つを組み合わせることで、ただ集客するだけではなく、<strong>「伝わる」ことで「選ばれる」マーケティング</strong>をつくる。</p>
          <p>それが、ウィルグローです。</p>
          </div>
        </div>
