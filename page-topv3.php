  ...
  <div class="loading-container">
        ...
        <div class="wrapper">
          ...
          <div class="fv-cta-cards">
            <a href="<?php echo esc_url( home_url('/btob-marketing-consultation/') ); ?>" target="_blank" rel="noopener noreferrer" class="fv-cta-card fv-cta-card--diagnosis">
              <span class="cta-text"><span class="cta-accent">「何から手をつけるか」</span><br>10問・約1分<br>ホームページとマーケティングの無料診断</span>
            </a>
          </div>
      ...
      <div class="container">
        <div class="wrapper">
          ...
          <div class="fv-cta-cards-sp">
            <a href="<?php echo esc_url( home_url('/btob-marketing-consultation/') ); ?>" target="_blank" rel="noopener noreferrer" class="fv-cta-card fv-cta-card--diagnosis">
              <span class="cta-text"><span class="cta-accent">「何から手をつけるか」</span><br>10問・約1分 ホームページとマーケティングの無料診断</span>
            </a>
          </div>
        </div>
      </div>
    ...
    <section class="page-topv3-issue">
      <div class="container">
        ...
        <?php /* PC(821px以上)のみパララックスを上書き。速度が負なのでスクロールに対して下方向に動く(移動量は 100×speed px = 上下±100px) */ ?>
