...
<head prefix="og: https://ogp.me/ns#">
  ...
  <script type="application/ld+json">
  {
    ...
    "@type": "FAQPage",
    "mainEntity": [
      {"@type": "Question", "name": "初期費用はいくらですか？", "acceptedAnswer": {"@type": "Answer", "text": "初期費用は100,000円（税抜）です。構成設計・オリジナルデザイン・WordPress構築などの初期構築費用にあたります。なお、独自機能の開発、写真撮影や原稿作成の代行、有料素材の購入などが必要な場合のみ、別途お見積もりをお出しします。追加費用が発生する場合は、必ず事前にご説明・ご承認のうえで進めますのでご安心ください。"}},
      {"@type": "Question", "name": "契約期間の縛りや違約金はありますか？", "acceptedAnswer": {"@type": "Answer", "text": "ありません。途中解約も可能です。無理な引き止めや違約金はなく、ご事情に応じて誠実に対応いたします。"}},
      {"@type": "Question", "name": "テンプレート制作ではありませんか？", "acceptedAnswer": {"@type": "Answer", "text": "テンプレート販売ではありません。事業・強み・ターゲットに合わせて、構成から設計するフルオーダー型です。"}},
      {"@type": "Question", "name": "SEO対策は含まれますか？", "acceptedAnswer": {"@type": "Answer", "text": "はい、基本的な内部SEO対策は月額内で標準対応します。具体的には、タイトル・ディスクリプション（検索結果に表示される文章）の設計、表示速度の最適化、スマホ対応、XMLサイトマップ（検索エンジンに構造を伝えるファイル）の設置、内部リンクの整理などを行い、検索エンジンに評価されやすい土台をつくります。記事更新やキーワード戦略など、継続的なSEO施策についても別途ご提案可能です。サイト公開後の運用フェーズに合わせて、段階的に取り組みを広げていけます。"}},
      {"@type": "Question", "name": "更新はどこまで対応してもらえますか？", "acceptedAnswer": {"@type": "Answer", "text": "月額内でテキスト修正・画像差し替えなどの軽微な更新を月2回まで対応します。それを超える追加更新や、新規ページ作成は別途お見積もりとなります。"}},
      {"@type": "Question", "name": "Webやマーケティングがわからなくても大丈夫ですか？", "acceptedAnswer": {"@type": "Answer", "text": "問題ありません。「何を載せればいいかわからない」という段階からご相談いただけます。"}},
      {"@type": "Question", "name": "成果（問い合わせ）が出るまでどのくらいかかりますか？", "acceptedAnswer": {"@type": "Answer", "text": "Webサイトの役割によってご期待いただく成果は異なります。私たちは、Webサイトは「比較検討時に選ばれる状態」を作るツールと考えています。つまり、見込み客がサイトに訪れるための認知施策（コンテンツSEO・SNS・広告・営業活動など）と、サイトでの意思決定を後押しする構造が揃ってはじめて、成果が生まれます。そのため「公開後◯ヶ月で問い合わせが◯件」という約束はいたしかねますが、サイト公開と並行して認知施策も整えていくことで、6ヶ月〜1年のスパンで成果が現れ始めるケースが多くあります。現状の集客施策の状況もお伺いしたうえで、現実的な見通しをお伝えします。まずは無料相談でご状況をお聞かせください。"}},
      {"@type": "Question", "name": "既存サイトのリニューアルにも対応できますか？", "acceptedAnswer": {"@type": "Answer", "text": "はい、対応しています。現状サイトのアクセス解析・課題整理から始め、リニューアルすべき構造・残すべき資産を見極めてご提案します。また、リニューアル時に検索順位や既存流入を落とさない移行設計（URL構造・リダイレクト・SEO資産の引き継ぎ）まで対応しますので、安心してご相談ください。詳しくはホームページリニューアルの進め方もご参考ください。"}},
      {"@type": "Question", "name": "契約終了後、サイトのデータはどうなりますか？", "acceptedAnswer": {"@type": "Answer", "text": "契約終了後は、原則としてWebサイトは非公開となります。ウィルサポは月額制でサイトを継続的に運用・改善していくサービスのため、契約期間中のご利用を前提としているためです。ただし、一定期間以上ご契約を継続いただいたお客様には、所定の条件のもとでサイトデータ一式（WordPressのファイル・データベース）をお引き渡しすることが可能です。他社さまへの運用移管や自社運用への切り替えもご検討いただけます。引き渡しの具体的な条件については、ご状況に応じてご案内しておりますので、無料相談の際にお気軽にお尋ねください。"}},
      {"@type": "Question", "name": "制作期間はどのくらいかかりますか？", "acceptedAnswer": {"@type": "Answer", "text": "最初のヒアリングから公開まで、おおよそ2〜3ヶ月が目安です。ページ数が多い場合や、原稿・写真のご準備にお時間がかかる場合は、もう少し長くなることもあります。お急ぎの事情がある場合は、優先順位を整理しながら最短で進められる進行プランをご提案します。"}},
      {"@type": "Question", "name": "福岡以外の地域でも対応できますか？", "acceptedAnswer": {"@type": "Answer", "text": "はい、全国どちらの地域でも対応可能です。打ち合わせはZoomなどのオンラインで実施し、画面共有をしながらサイトの状況や改善案をその場で確認できるため、地域を問わず同じ品質・スピードでご支援させていただきます。"}},
      {"@type": "Question", "name": "自社ECサイトや自社ネットショップなども作成できますか？", "acceptedAnswer": {"@type": "Answer", "text": "はい、対応可能です。ECサイト（ネットショップ）の構築・運用については、「ウィルサポEC」という専用プランでご支援しています。Shopify（ショッピファイ／世界的に利用されているネットショップ作成サービス）を使って、商品登録・決済・配送設定まで含めたネットショップを構築・運用いたします。「ウィルサポ」は会社の信頼づくりや問い合わせ獲得を目的としたコーポレートサイト・サービスサイト向け、「ウィルサポEC」は商品をネットで販売したい方向けのプランです。どちらが合うかわからない場合も、無料相談でご状況をお聞きしてご提案しますので、お気軽にご相談ください。「ウィルサポEC」のサービスページを見る→"}},
      {"@type": "Question", "name": "採用サイトは作成できますか？", "acceptedAnswer": {"@type": "Answer", "text": "はい、採用サイトの制作にも対応しています。採用サイトは「どんな会社で、どんな人と働けるのか」を伝えることで、求める人材から応募いただくための大切なツールです。ウィルサポでは、会社の想いや働く人の雰囲気、仕事内容、募集要項、エントリーフォームまでを含めた採用サイトを、月額制で構築・運用できます。求職者が知りたい情報を整理し、求人媒体（Indeed、タウンワークなど）との併用も見据えた設計でご提案します。採用活動の方針や現状の課題に合わせてご提案いたしますので、まずは無料相談でお気軽にご相談ください。"}}
    ]
  }
  </script>
