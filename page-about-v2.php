      ...
      <div class="message-list">
        ...
        <div class="message-item">
          ...
          <div class="message-item-body">
            ...
            <p class="message-item-text">アメリカの大学でマネジメントとマーケティングを学び、その後、IT企業でマーケティング部門に10年間携わりました。マーケティングから内勤営業チームのマネジメントなど、集客から販売までの実践的なビジネススキルを磨いてきました。マーケティングを通じて地方の個人や中小企業様の事業の発展をサポートし、地域経済の活性化に貢献していきたいと思います。私たちは、お客様一人ひとりのご要望に合わせた最適な集客戦略を提供することで、皆様のビジネスの成長をサポートしてまいります。</p>
          </div>
        </div>
